                ...
                <div class="p-8">
                    <form action="{{ route('admin.medicines.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Satuan -->
                            <div>
                                <label for="unit" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Satuan (Contoh: Tablet, Botol)</label>
                            ...
                            <!-- Stok -->
                            <div>
                                <label for="stock" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Stok Awal</label>
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea name="description" id="description" rows="3"
                                          class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:text-white transition">{{ old('description') }}</textarea>
                        ...
                        <div class="mt-8 flex items-center justify-end space-x-4">
                            ...
                            <button type="submit"
                                    class="px-6 py-2 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold rounded-lg shadow-lg hover:from-emerald-600 hover:to-teal-700 transform hover:-translate-y-0.5 transition-all">
                                Simpan Obat
                            </button>
                        </div>
                    </form>
